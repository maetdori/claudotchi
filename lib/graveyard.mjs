...
// lifespan (context usage hits the configured lifespan — 40% by default) or is
// handed over at /compact leaves a tombstone, so a lineage and a family tree can
// be reconstructed across sessions.
