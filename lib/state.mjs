// state.mjs — persistence for claudchi pet state.
//
// All pet data lives under ~/.claude/claudchi/ so that every Claude Code
...
export const BASE_DIR = join(homedir(), '.claude', 'claudchi');
