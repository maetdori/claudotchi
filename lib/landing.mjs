...
<style>
  ...
  *{box-sizing:border-box}
  ...
  h1{font-size:clamp(40px,7vw,68px);font-weight:800;line-height:1.02;letter-spacing:-2px;margin:0 0 18px}
  h1 .dash{color:var(--clay)}
...
<div class="wrap">
  <header>
    ...
    <h1>클로도치 <span class="dash">—</span> AI를 쓰는 만큼 자라는 펫</h1>
    ...
    <div class="cta">
      ...
      <a class="btn ghost" href="dogam.html">전체 도감 보기 🥚</a>
    </div>
...
<span class="c">/plugin</span> install claudochi</pre>
  ...
  <footer>
    ...
    <span><a href="${REPO}" target="_blank" rel="noopener">github.com/maetdori/claudochi</a> · <a href="dogam.html">전체 도감 →</a></span>
  </footer>
</div>
</body>
</html>`;
