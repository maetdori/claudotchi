...
<style>
  ...
  *{box-sizing:border-box}
  ...
  h1{font-size:clamp(36px,6vw,60px);font-weight:800;line-height:1.06;letter-spacing:-1.5px;margin:0 0 18px;color:var(--ink)}
  h1 .dash{color:var(--ink);font-weight:800}
