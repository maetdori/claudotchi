...
const STONE = [156, 160, 168]; // cool slate — the web 생애주기 스트립의 죽음 묘비 (터미널 렌더는 ASCII 유지)
...
export const SPRITES = {
  ...
  // 🪦 non-pet decoration: the web 생애주기 스트립 죽음 노드용 픽셀 묘비. 둥근 윗면 +
  // 다크 십자가. 터미널 상태표시줄은 ASCII 비석을 그대로 쓰므로 여기엔 관여하지 않음.
  grave: { body: STONE, grid: ['·OOO·', 'OOkOO', 'OkkkO', 'OOkOO', 'OOkOO', 'OOOOO'] },
};
