...
export const NODES = {
  ...
  alklo: { name: '아기클',  emoji: '🐣', stage: 'baby', branchStat: 'intel', children: { high: 'ddolttol', mid: 'pyeongbeom', low: 'malsseong' } },

  // children (decided by diligence during the child stage)
  ddolttol:   { name: '똘똘클', emoji: '🐤', stage: 'child', branchStat: 'dilig', children: { high: 'busy_model',  low: 'relaxed_genius' } },
  pyeongbeom: { name: '평범클', emoji: '🐤', stage: 'child', branchStat: 'dilig', children: { high: 'diligent_avg', low: 'relaxed_avg' } },
  malsseong:  { name: '말썽클', emoji: '🐤', stage: 'child', branchStat: 'dilig', children: { high: 'busy_trouble', low: 'neglected_trouble' } },

  // teens (decided by cleanliness during the teen stage)
  busy_model:        { name: '근면클', emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'master',        low: 'nerd' } },
  relaxed_genius:    { name: '여유클',     emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'pro',           low: 'basement_genius' } },
  diligent_avg:      { name: '성실클',     emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'model_citizen', low: 'glutton' } },
  relaxed_avg:       { name: '느긋클',     emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'mypace',        low: 'lazy' } },
  busy_trouble:      { name: '부산클',   emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'clown',         low: 'berserk' } },
  neglected_trouble: { name: '방치클',     emoji: '🧒', stage: 'teen', branchStat: 'clean', children: { high: 'zombie',        low: 'oyaji' } },

  // adults (leaves) — the fixed roster + their grade
  master:          { name: '마스터클',   emoji: '✨', stage: 'adult', grade: 'S', profile: '지능·성실·청결 모두 高 — 이상적 활용' },
  nerd:            { name: '너드클',     emoji: '🧪', stage: 'adult', grade: 'A', profile: '똑똑하나 에러를 방치 (청결 低)' },
  pro:             { name: '프로클',     emoji: '😎', stage: 'adult', grade: 'A', profile: '느긋하지만 정확 (청결 高)' },
  basement_genius: { name: '방구석클',     emoji: '🦥', stage: 'adult', grade: 'B', profile: '재능은 있는데 성실·청결이 아쉬움' },
  model_citizen:   { name: '모범클', emoji: '🙂', stage: 'adult', grade: 'B', profile: '고루 양호' },
  glutton:         { name: '먹보클',     emoji: '🐷', stage: 'adult', grade: 'C', profile: '열심인데 지저분 (청결 低)' },
  mypace:          { name: '마페클', emoji: '🐱', stage: 'adult', grade: 'C', profile: '깔끔하지만 띄엄띄엄 (성실 低)' },
  lazy:            { name: '게으른클',       emoji: '🥱', stage: 'adult', grade: 'C', profile: '전반적으로 저조' },
  clown:           { name: '삐에로클',   emoji: '🤡', stage: 'adult', grade: 'D', profile: '바쁜데 헛심 (지능 低)' },
  berserk:         { name: '폭주클',     emoji: '👹', stage: 'adult', grade: 'D', profile: '마구잡이 (지능·청결 低)' },
  zombie:          { name: '좀비클',     emoji: '🧟', stage: 'adult', grade: 'D', profile: '방치됨 (성실·지능 低)' },
  oyaji:           { name: '아재클',       emoji: '🧓', stage: 'adult', grade: 'F', profile: '성의없음 누적 — 전 축 최하' },
  legend:          { name: '레전드클',   emoji: '🌟', stage: 'adult', grade: '★', profile: '히든 — 완벽한 케어 + 명문 혈통' },
};
