// cli.mjs — backs the /claude-tamagotchi:breed and :family slash commands.
...
function printList(list) {
  ...
  console.log('교배 후보 (번호 두 개를 골라 `/claude-tamagotchi:breed i j`):\n');
  list.forEach((c, i) => console.log(`  ${i + 1}. ${label(c)}`));
  console.log('\n예) /claude-tamagotchi:breed 1 2');
}
