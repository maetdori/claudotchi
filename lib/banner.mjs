...
// terminal mockup — the "쿨" charcoal/slate theme from the original design mockup
// (neutral cool tone, like a real terminal — not a saturated navy). Neutral border,
// cool-grey body text; the green/clay/gold accents still pop.
const SCREEN = '#191a20', BAR = '#23252e', BAR_LINE = '#30323d', RING = 'rgba(126,130,146,.6)';
const T_PROMPT = '#8a8f98', T_PATH = '#c2c7d2', T_GIT = '#6ec878';
const T_CLAY = '#d77757', T_MUTED = '#9aa0b0', GOLD = '#e8c15c';
